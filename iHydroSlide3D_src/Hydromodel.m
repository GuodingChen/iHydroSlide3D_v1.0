function [cSM,channel,overland,interflow,infil,sr,cP,cERO,cERI,cPOT,caET] = Hydromodel(rundata,cSM,Pin,PET,dt,tstep,compgrid,dx,NEXTTIMEUNDER,TH,ALPHA,BETA,SLOPE_TH)
